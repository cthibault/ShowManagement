...
namespace ShowManagement.WindowsServices.NameResolver.Services
{
    class Program
    {
        ...
        {
            TraceSourceManager.TraceSource.TraceWithDateFormat(TraceEventType.Verbose, 0, "Enter ShowManagement.WindowsServices.NameResolver.Services.Program.Main()");
            ...
            catch (Exception ex)
            {
                ...
                TraceSourceManager.TraceSource.TraceWithDateFormat(TraceEventType.Critical, 0, "Exception caught in ShowManagement.WindowsServices.NameResolver.Services.Program.Main(): {0}.", exceptionMessage);
