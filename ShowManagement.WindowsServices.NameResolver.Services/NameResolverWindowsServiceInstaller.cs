...
namespace ShowManagement.WindowsServices.NameResolver.Services
{
    ...
    public class NameResolverWindowsServiceInstaller : Installer
    {
        ...
        {
            TraceSourceManager.TraceSource.TraceWithDateFormat(TraceEventType.Verbose, 0, "Enter ShowManagement.WindowsServices.NameResolver.Services.NameResolverWindowsServiceInstaller()");
            ...
            TraceSourceManager.TraceSource.TraceWithDateFormat(TraceEventType.Verbose, 0, "Exit ShowManagement.WindowsServices.NameResolver.Services.NameResolverWindowsServiceInstaller()");
        }
