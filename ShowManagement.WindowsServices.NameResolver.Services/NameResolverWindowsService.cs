...
using ShowManagement.WindowsServices.NameResolver.Services.Diagnostics;
using System;
...
namespace ShowManagement.WindowsServices.NameResolver.Services
{
    partial class NameResolverWindowsService : ServiceBase
    {
        ...
        public void Start()
        {
            TraceSourceManager.TraceSource.TraceWithDateFormat(TraceEventType.Verbose, 0, "Enter ShowManagement.WindowsServices.NameResolver.Services.NameResolverWindowsService.Start()");
            ...
            TraceSourceManager.TraceSource.TraceWithDateFormat(TraceEventType.Verbose, 0, "Exit ShowManagement.WindowsServices.NameResolver.Services.NameResolverWindowsService.Start()");
        }
        ...
        public void Stop()
        {
            TraceSourceManager.TraceSource.TraceWithDateFormat(TraceEventType.Verbose, 0, "Enter ShowManagement.WindowsServices.NameResolver.Services.NameResolverWindowsService.Stop()");
            ...
            TraceSourceManager.TraceSource.TraceWithDateFormat(TraceEventType.Verbose, 0, "Exit ShowManagement.WindowsServices.NameResolver.Services.NameResolverWindowsService.Stop()");
        }
        ...
        {
            TraceSourceManager.TraceSource.TraceWithDateFormat(TraceEventType.Verbose, 0, "Enter ShowManagement.WindowsServices.NameResolver.Services.NameResolverWindowsService.Install()");
            ...
            catch (Exception ex)
            {
                ...
                TraceSourceManager.TraceSource.TraceWithDateFormat(TraceEventType.Error, 0, "Exception caught in ShowManagement.WindowsServices.NameResolver.Services.NameResolverWindowsService.Install(): {0}", exceptionMessage);
                Console.Error.WriteLine("Exception was raised during Service Install:");
                Console.Error.WriteLine(exceptionMessage);
            }

            TraceSourceManager.TraceSource.TraceWithDateFormat(TraceEventType.Verbose, 0, "Exit ShowManagement.WindowsServices.NameResolver.Services.NameResolverWindowsService.Install()");
        }

        public static void Uninstall(string[] args)
        {
            TraceSourceManager.TraceSource.TraceWithDateFormat(TraceEventType.Verbose, 0, "Enter ShowManagement.WindowsServices.NameResolver.Services.NameResolverWindowsService.Uninstall()");
            ...
            catch (Exception ex)
            {
                ...
                TraceSourceManager.TraceSource.TraceWithDateFormat(TraceEventType.Error, 0, "Exception caught in ShowManagement.WindowsServices.NameResolver.Services.NameResolverWindowsService.Uninstall(): {0}", exceptionMessage);                
                Console.Error.WriteLine("Exception was raised during Service Uninstall:");
                Console.Error.WriteLine(exceptionMessage);
            }

            TraceSourceManager.TraceSource.TraceWithDateFormat(TraceEventType.Verbose, 0, "Exit ShowManagement.WindowsServices.NameResolver.Services.NameResolverWindowsService.Uninstall()");
        }
