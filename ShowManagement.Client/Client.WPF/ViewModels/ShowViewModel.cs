...
namespace ShowManagement.Client.WPF.ViewModels
{
    class ShowViewModel : TrackableObject
    {
            ...
            : base(unityContainer, true)
        {
            ...
            this.TvdbSearchViewModel = new TvdbSearchViewModel(this.UnityContainer, this.UnityContainer.Resolve<ITvdbSearchProvider>(), this);
        ...
        #region TvdbSearchViewModel
        public TvdbSearchViewModel TvdbSearchViewModel { get; private set; }
        #endregion
        ...
        public const string NEWSHOW_NAME = "_New Show";
        #endregion
    }
}
