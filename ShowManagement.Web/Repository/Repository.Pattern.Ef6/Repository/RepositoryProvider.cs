...
namespace Repository.Pattern.Ef6.Repository
{
    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        public RepositoryProvider(RepositoryFactories repositoryFactories)
        {
            ...
            this.Repositories = new Dictionary<Type, dynamic>();
        }
        ...
        /// </remarks>
        public IRepositoryAsync<TEntity> GetRepositoryForEntityType<TEntity>() where TEntity : class, IObjectState
        {
            return this.GetRepository<IRepositoryAsync<TEntity>>(this._repositoryFactories.GetRepositoryFactoryForEntityType<TEntity>());
        }
        ...
        public virtual T GetRepository<T>(Func<IDataContextAsync, IUnitOfWorkAsync, dynamic> factory = null) where T : class
        {
            ...
            if (!Repositories.TryGetValue(typeof(T), out repository))
            {
                ...
                repository = this.MakeRepository<T>(factory, this.DataContext, this.UnitOfWork);
            }
        ...
        /// </param>
        /// <returns></returns>
        protected virtual T MakeRepository<T>(Func<IDataContextAsync, IUnitOfWorkAsync, dynamic> factory, IDataContextAsync context, IUnitOfWorkAsync uow)
            where T : class
        {
            var repositoryFactory = factory ?? this._repositoryFactories.GetRepositoryFactory<T>();
            ...
            var repository = repositoryFactory(context, uow);
